# Operator Quickstart — Manufacture of Glass and Glass Products

Shortest path from clone to a verified local dry-run for **ISIC 2310** (`cloud-itonami-isic-2310`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2310.git
cd cloud-itonami-isic-2310
```
...
- Blueprint governor key: `tempering-governor`
- Likely source path: `glassworks.governor.cljc`
